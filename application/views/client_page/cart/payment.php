    ...
    <div id="wrap_block_2" class="container kmt_inside">
        ...
        <div class="row wrap_center">
           ...
           <div class="kmt_title"><span><?php if($this->lan=='vi'){echo 'Thông tin thanh toán bằng tiền mặt - chuyển khoản';}else{echo 'Cash, bank transfer PAYMENT INFOMATION';}?></span></div>
           ...
           <div class="col-lg-12">
                        ...
                        <div class="row" style="padding-top: 30px;">
                            ...
                            <form class="form-horizontal" role="form" action="<?php echo base_url('finish-cart')?>" method="post" id="kmt_payment_form">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                      <a href="<?php echo base_url('payment-paypal')?>">
                                        Bấm vào link này nếu bạn muốn thanh toán bằng thẻ tín dụng?
                                      </a>
                                    </div>
                                  </div>
                                  <div class="form-group">
                            ...
                            <form class="form-horizontal" role="form" action="<?php echo base_url('finish-cart')?>" method="post" id="kmt_payment_form">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                      <a href="<?php echo base_url('payment-paypal')?>">
                                        Click on this link if you want to pay by credit card?
                                      </a>
                                    </div>
                                  </div>
                                  <div class="form-group">
