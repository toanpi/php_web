        ...
        <div id="kmt_admin_content">
            ...
            <form action="" method="post" id="form">
                <table class="kmt_admin_table">
                    ...
                    <tr <?php if($i%2==0){echo "class='kmt_admin_c1'";}else{echo "class='kmt_admin_c2'";}?>>
                        ...
                        <td><a href="<?php echo base_url()?>admin_item/img_child/<?php echo $value->MaHinh?>"><?=$value->Ten_vi?></a></td>
                        <td>
                            <?php
                                $MaHinh = $value->MaHinh;
            ...
            <div class="kmt_admin_bar_3">
                <p style="width: 100%;text-align: right;">
                    <input class="button_admin" id="bt_copy" type="button" value="Sao chép"/>
                    ...
                    <select class="kmt_hidden" id="idMN_3_filter"></select>
                    <input type="button" value="Lọc" class="button" onclick="window.location='<?=base_url()?>admin_item/item_filter/'+document.getElementById('idMN_1_filter').value+'/'+document.getElementById('idMN_2_filter').value"/>
                </p>
                ...
                <p style="width: 100%;text-align: left;">
                    ...
                    <select onchange="changeForm();" id="selectBox">
                        ...
                        <option value="5" class="kmt_hidden">dự án mới</option>
