            ...
            <form action="" method="post" id="form">
                <table class="kmt_admin_table">
                    ...
                    <tr <?php if($i%2==0){echo "class='kmt_admin_c1'";}else{echo "class='kmt_admin_c2'";}?>>
                        ...
                        <td>
                           <?php if($value->Moi==1){?>
                             <a href="javascript:void(0)" onclick="udp_status('<?=$url?>','idIT','Moi', 0)">
                                <img src="<?=base_url()?>public/admin/img/on.gif"/>
                             </a>
                           <?php }else{?>
                             <a href="javascript:void(0)" onclick="udp_status('<?=$url?>','idIT','Moi', 1)">
                                <img src="<?=base_url()?>public/admin/img/off.gif"/>
                             </a>
                           <?php }?>
                        </td>
            ...
            <div class="kmt_admin_bar_3">
                <p style="width: 100%;text-align: left;">
                    ...
                    <select onchange="changeForm();" id="selectBox">
                        ...
                        <option value="8">Bỏ chọn mới</option>
           ...
           if(selectedValue=='0'){
               ...
               switch (selectedValue) { 
                    ...
                    case '4': 
                        ...
                        break;
                    case '7': 
                        url = "<?=base_url()?>same_method/upp_status_list/kmt_item/idIT/7";
                        $("#form").attr("action", url);
                        $('#form').submit();
                        break;      
                    case '8': 
                        url = "<?=base_url()?>same_method/upp_status_list/kmt_item/idIT/8";
                        $("#form").attr("action", url);
                        $('#form').submit();
                        break;
                    default:
