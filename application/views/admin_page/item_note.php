            ...
            <div class="kmt_admin_bar_3">
                <p style="width: 100%;text-align: left;">
                    ...
                    <select class="selectBox">
                        ...
                        <option value="1">Chọn là sản phẩm tiêu biểu</option>
                        <option value="2">Bỏ chọn sản phẩm tiêu biểu</option>
...
<script type="text/javascript">
       ...
       $(this).on('click', '.bt_copy', function() { 
            ...
            if(confirm('Bạn có chắc muốn sao chép các sản phẩm đã chọn?')==true){
                $("#form").attr("action", url);
                $('#form').submit();
            }else{
                return false;
