...
<!-- Begin kmt_admin_middle_right-->
    <div id="kmt_admin_middle_right">
        <h1 style="text-transform: uppercase;">BÀI VIẾT THUỘC MỤC - <?=$title_type_articles?></h1>
                ...
                <p>
                    ...
                    <select class="idNBV_filter">
                        ...
                        ?>
                            ...
                            if($idNBV_f == 0){
                            ?>
                                <option value="<?=$value->idNBV?>"><?=$value->TenNhom_vi?></option>
                            
                            <?php }else{?>
                                <option <?php if($idNBV_f == $value->idNBV){ echo 'selected="selected"';}?> value="<?=$value->idNBV?>"><?=$value->TenNhom_vi?></option>
                            <?php }?>
                        <?php } ?>
                    </select>
                    <select class="idMN_1_filter">
                ...
                <table class="kmt_admin_table">
                    ...
                    ?>
                     ...
                     <tr <?php if($i%2==0){echo "class='kmt_admin_c1'";}else{echo "class='kmt_admin_c2'";}?>>
                        ...
                        <td><a onclick="return confirm('Bạn có chắc muốn xóa bài viết đã chọn!')" href="<?=base_url()?>same_method/del_one/kmt_baiviet/<?=$value->idBV?>"><img src="<?=base_url()?>public/admin/img/b_drop.png"/></a></td>
...
<script type="text/javascript">
       ...
       $(this).on('click', '.bt_copy', function() { 
        ...
        $(this).on('click', '.bt_del', function() { 
	        var url = "<?=base_url()?>same_method/del_all/kmt_baiviet";
            if(confirm(' Bạn có chắc muốn xóa các bài viết đã chọn?')==true){
                $("#form").attr("action", url);
                $('#form').submit();
            }else{
                return false;
           ...
           if(selectedValue=='0'){
               ...
               switch (selectedValue) { 
                    ...
                    case '4': 
                        ...
                        break;
                    default:
                        if(confirm('Bạn có chắc muốn xóa những bài viết này ko?')==true){
                            var url = "<?=base_url()?>same_method/del_all/kmt_baiviet";
                            $("#form").attr("action", url);
                            $('#form').submit();
                        }else{
