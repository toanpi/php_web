...
<!-- Begin kmt_admin_middle_right-->
    <div id="kmt_admin_middle_right">
        <h1 style="text-transform: uppercase;">BÀI VIẾT THUỘC MỤC - <?php echo $title_type_articles?></h1>
        <div id="kmt_admin_content">
            ...
            <div class="kmt_admin_bar_1">
                ...
                <div class="kmt_admin_search">
                    <form action="<?php echo base_url()?>admin_articles/articles_search" method="post">
                        <input name="keyword" type="text" required="required" placeholder="Nhập từ khóa ..."/>
                        <input name="idLBV" value="<?php echo $idLBV?>" type="hidden"/>
            ...
            <div class="kmt_admin_bar_3" style="border-radius: 0px;">
                <p>
                    <a href="<?php echo base_url()?>admin_articles/add_articles/<?php echo $idLBV?>"><input type="button" value="Thêm mới"/></a>
                ...
                <p>
                    ...
                    <select class="idNBV_filter">
                        ...
                        ?>
                            ...
                            if($idNBV_f == 0){
                            ?>
                                <option value="<?php echo $value->idNBV?>"><?php echo $value->TenNhom_vi?></option>
                            
                            <?php }else{?>
                                <option <?php if($idNBV_f == $value->idNBV){ echo 'selected="selected"';}?> value="<?php echo $value->idNBV?>"><?php echo $value->TenNhom_vi?></option>
                            <?php }?>
                        <?php } ?>
                    </select>
            ...
            <form action="" method="post" id="form">
                ...
                <table class="kmt_admin_table">
                    ...
                    ?>
                     <input type="hidden" name="id[]" value="<?php echo $value->idBV?>"/>
                     <tr <?php if($i%2==0){echo "class='kmt_admin_c1'";}else{echo "class='kmt_admin_c2'";}?>>
                        <td><input class="item" type="checkbox" value="<?php echo $value->idBV?>" name="id_check[]"/></td>
                        <td><a href="<?php echo base_url()?>admin_articles/edit_articles/<?php echo $value->idBV?>"><img src="<?php echo base_url()?>public/admin/img/b_edit.png"/></a></td>
                        <td><input type="text" value="<?php echo $value->STT?>" name="stt[]"/></td>
                        <td>
                               <?php if($value->TrangThai==1){?>
                                 <a href="javascript:void(0)" onclick="udp_status('<?php echo $url?>','idBV','TrangThai', 0)">
                                    <img src="<?php echo base_url()?>public/admin/img/on.gif"/>
                                 </a>
                               <?php }else{?>
                                 <a href="javascript:void(0)" onclick="udp_status('<?php echo $url?>','idBV','TrangThai', 1)">
                                    <img src="<?php echo base_url()?>public/admin/img/off.gif"/>
                                 </a>
                               <?php }?>
                        </td>
                        <td><?php echo $value->TieuDe_vi?></td>
                        ...
                        <td>
                               <?php if($value->TieuBieu==1){?>
                                 <a href="javascript:void(0)" onclick="udp_status('<?php echo $url?>','idBV','TieuBieu', 0)">
                                    <img src="<?php echo base_url()?>public/admin/img/on.gif"/>
                                 </a>
                               <?php }else{?>
                                 <a href="javascript:void(0)" onclick="udp_status('<?php echo $url?>','idBV','TieuBieu', 1)">
                                    <img src="<?php echo base_url()?>public/admin/img/off.gif"/>
                                 </a>
                               <?php }?>
                        </td>
                        ...
                        <td><a onclick="return confirm('Bạn có chắc muốn xóa bài viết đã chọn! Nếu còn bài viết con bạn sẽ không xóa được bài viết này!')" href="<?php echo base_url()?>same_method/del_one_check/kmt_baiviet/<?php echo $value->idBV?>"><img src="<?php echo base_url()?>public/admin/img/b_drop.png"/></a></td>
    ...
    <script type="text/javascript">
	   $(this).on('click', '.bt_ud', function() { 
	        var url = "<?php echo base_url()?>same_method/ud_numbers/kmt_baiviet/idBV";
       ...
       $(this).on('click', '.bt_copy', function() { 
	        var url = "<?php echo base_url()?>admin_articles/articles_copy/<?php echo $idLBV?>";
        ...
        $(this).on('click', '.bt_del', function() { 
	        var url = "<?php echo base_url()?>same_method/del_all_check/kmt_baiviet";
       ...
       $(this).on('change','.selectBox', function() {
           ...
           var url = "<?php echo base_url()?>same_method/upp_status_list/kmt_baiviet/idBV/1";
           if(selectedValue=='0'){
        	   return false;
           }else{
               //begin Swich
               switch (selectedValue) { 
                    case '1': 
                        ...
                        break;
                    case '2': 
                        url = "<?php echo base_url()?>same_method/upp_status_list/kmt_baiviet/idBV/2";
                        $("#form").attr("action", url);
                        $('#form').submit();
                        break;
                    case '3': 
                        url = "<?php echo base_url()?>same_method/upp_status_list/kmt_baiviet/idBV/3";
                        $("#form").attr("action", url);
                        $('#form').submit();
                        break;      
                    case '4': 
                        url = "<?php echo base_url()?>same_method/upp_status_list/kmt_baiviet/idBV/4";
                        $("#form").attr("action", url);
                        $('#form').submit();
                        break;
                    default:
