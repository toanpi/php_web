...
?>
    ...
    <div id="kmt_admin_middle_right">
        ...
        <div id="kmt_admin_content">
            ...
            <form action="<?=base_url()?>admin_img/save_img_album" method="post">
                ...
                <table class="kmt_admin_addarticles">
                    <tr>
                        ...
                        <td class="left">
                            ...
                            <input onclick="BrowseServer('Files:/album/','imageP')" class="kmt_buttoninput" type="button" value="Chọn hình đại diện"/>
                        </td>
                    </tr>
                            ...
                            <div id="tab-1" class="tab-content">
                                <table class="kmt_admin_addarticles">
                                    ...
                                    <tr>
                                        ...
                                        <td class="left">
                                            <input class="kmt_textinput" name="TenHinh_vi" type="text" placeholder="Vui lòng nhập tên hình"/>
                                        </td>
                                    </tr>
                                    <!-- End title -->
                            ...
                            <div id="tab-2" class="tab-content">
                                <table class="kmt_admin_addarticles">
                                    ...
                                    <tr>
                                        ...
                                        <td class="left">
                                            <input class="kmt_textinput" value="noname" name="TenHinh_en" type="text" placeholder="Please enter img name"/>
                                        </td>
                                    </tr>
                                    <!-- End title -->
