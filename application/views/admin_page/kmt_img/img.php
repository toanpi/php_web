...
<!-- Begin kmt_admin_middle_right-->
    <div id="kmt_admin_middle_right">
        <h1 style="text-transform: uppercase;">HÌNH ẢNH THUỘC MỤC - <?=$title_type_img?></h1>
        <div id="kmt_admin_content">
                ...
                <table class="kmt_admin_table">
                    ...
                    ?>
                     ...
                     <tr <?php if($i%2==0){echo "class='kmt_admin_c1'";}else{echo "class='kmt_admin_c2'";}?>>
                        ...
                        <td><a href="<?=base_url()?>admin_img/edit_img/<?=$value->idH?>/<?=$value->MaHinh?>"><img src="<?=base_url()?>public/admin/img/b_edit.png"/></a></td>
                        ...
                        <td class="kmt_img_ad">
                                ...
                                ?>
                                <a href="<?php echo base_url($UrlHinh)?>" class="fancybox"><img src="<?php echo base_url($UrlHinh)?>" height="50px"/></a>
                        </td>
                        <?php
                            if($Page == 1){
                        ?>
            ...
            <div class="kmt_admin_bar_3">
                <p>
                    <a href="<?=base_url()?>admin_img/add_img/<?=$idLH?>"><input type="button" value="Thêm một hình"/></a>
                ...
                <p>
                    <?php
                        if($NhieuHinh == 1){
                    ?>
                    <a href="<?=base_url()?>admin_img/add_list_img/<?=$idLH?>"><input type="button" value="Thêm nhiều hình"/></a>
                    <?php }?>
                    ...
                    <select id="idP_filter">
                        <option value="0">Hình chung</option>
                        <?php
                            foreach($list_page as $value_p){
                               if($value_p->idP!=1 && $value_p->idP!=8){     
                        ?>
