<!-- Begin kmt_admin_middle_right-->
    <div id="kmt_admin_middle_right">
        <h1>THÊM MỚI NHÓM TÀI LIỆU - FILES</h1>
        <div id="kmt_admin_content">
            ...
            <form action="<?=base_url()?>admin_file/save_file_group" method="post">
                ...
                <table class="kmt_admin_addarticles kmt_hidden">
                    <tr>
                        ...
                        <td class="left">
                            ...
                            <input onclick="BrowseServer('Files:/nhombaiviet/','imageP')" class="kmt_buttoninput" type="button" value="Chọn hình đại diện"/>
                        </td>
                    </tr>
                </table>
                ...
                <div class="kmt_admin_tablink">
                            ...
                            <div id="tab-1" class="tab-content">
                                <table class="kmt_admin_addarticles">
                                    ...
                                    <tr>
                                        ...
                                        <td class="left">
                                            <input class="kmt_textinput" name="TenNhom_vi" type="text" placeholder="Vui lòng điền tên nhóm"/>
                                        </td>
                                    </tr>
                                    <!-- End title -->
                    ...
                    <table class="kmt_admin_addarticles">
                        <tr>
                            <td colspan="2">
                                <input type="submit" class="kmt_buttoninput" value="Thêm mới nhóm"/>
