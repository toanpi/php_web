...
<!-- Begin kmt_admin_middle_right-->
    <div id="kmt_admin_middle_right">
        <h1 style="text-transform: uppercase;">TÀI LIỆU - FILES</h1>
                ...
                <p>
                    ...
                    <select id="idNF_filter">
                        ...
                        ?>
                            ...
                            <?php }else{?>
                                <option <?php if($idNF_f == $value_fg->idNF){ echo 'selected="selected"';}?> value="<?=$value_fg->idNF?>"><?=$value_fg->TenNhom_vi?></option>
                            <?php }?>
                        <?php }?>
                            
                    </select>
                    <input type="button" value="Lọc" class="button" onclick="window.location='<?=base_url()?>admin_file/file_filter/'+document.getElementById('idNF_filter').value"/>
