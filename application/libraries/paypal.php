...
class Paypal {
	 ...
	 * @return	void
	 */	
	function add($item_name = '',$item_amount = NULL,$item_qty = NULL,$item_number = NULL,$item_type=NULL){
        ...
        $this->config['on0_'.$this->item] 	= 'License type';
        $this->config['os0_'.$this->item] 	= $item_type;
		$this->item++;
	}	
}
// END Paypal Class
